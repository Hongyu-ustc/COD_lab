...
#
# Generated by Vivado on Fri May 17 17:01:42 +0800 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../cpu_ddu.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../cpu_ddu.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../cpu_ddu.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
